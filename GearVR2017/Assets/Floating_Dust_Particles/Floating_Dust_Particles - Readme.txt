A cloud of floating dust particle motes to add atmosphere to your environment.

Simply load the example Floating_Dust_Particles.unity scene, or drag the Floating_Dust_Particles.prefab from the Prefabs folder into the Hierarchy window.
